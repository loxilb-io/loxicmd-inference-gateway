# loxicmd-inference-gateway Governance

`loxicmd-inference-gateway` is part of the [LoxiLB](https://github.com/loxilb-io) project and follows the LoxiLB
...
loxicmd-inference-gateway Maintainers have write access to the
[loxicmd-inference-gateway GitHub repository](https://github.com/loxilb-io/loxicmd-inference-gateway). They review and merge pull
