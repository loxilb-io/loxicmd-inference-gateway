# loxicmd-inference-gateway Maintainers

This is the current list of maintainers for the loxicmd-inference-gateway project. See
[GOVERNANCE.md](./GOVERNANCE.md) for the roles and responsibilities of maintainers and how to become
one.
...
| <img width="30px" src="https://avatars.githubusercontent.com/u/328939390"> | [loxilb-devel](https://github.com/loxilb-devel)      |  Netlox   |

<!--
  Keep this list in sync with .github/CODEOWNERS. When adding or removing a maintainer, update both
  files and grant/revoke the corresponding GitHub write access. Confirm the roster for loxicmd-inference-gateway
  specifically — it is seeded from the LoxiLB Maintainer Council and may differ.
-->

If any person or organization wants to become a maintainer of loxicmd-inference-gateway, please review the
[Governance Guide](./GOVERNANCE.md) for details.
